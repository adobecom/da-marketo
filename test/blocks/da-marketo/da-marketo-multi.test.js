...
import init, { formValidate, updateTabIndex } from '../../../mkto/blocks/da-marketo/da-marketo-multi.js';
import { setConfig } from './mocks/utils.js';
...
describe('da-marketo multi-step', () => {
  let clock;
