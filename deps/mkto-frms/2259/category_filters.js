...
if (typeof fld_push_mktoFormsFunctionalAreaCategory != "function") {
  console.log("Category Filters - Loaded");
  ...
  fld_push_mktoFormsFunctionalAreaCategory = async function () {
    ...
    if (mktoFormsFunctionalAreaCategory) {
      ...
      if (window?.mcz_marketoForm_pref?.profile?.known_visitor) {
        console.log("Known Visitor - mktoFormsFunctionalAreaCategory");
      } else {
