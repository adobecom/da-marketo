...
export const adobeRegionalSite = {
...
export const B2B_RFI_COUNTRIES = [
  'AT',
  'BE',
  'BG',
  'HR',
...
export const PRIVACY_CODE_DEFAULT = {
  purpose: [''],
  countries: [''],
  ...
  privacy_links: {
    ...
    'regional-privacy-policy-info-share':
      'https://www.adobe.com/{adobeRegionalSite}/privacy/policy.html#info-share',
    'regional-privacy-marketing-email':
      'https://www.adobe.com/{adobeRegionalSite}/privacy/marketing.html#mktg-email',
    'regional-optout-comm':
      'https://www.adobe.com/{adobeRegionalSite}/privacy/opt-out.html#communication',
  },
};

//
// Privacy Code Rules
export const PRIVACY_CODE_RULES = [
  {
  ...
  },
  {
    ...
    optin_style: 'explicit',
    methods: ['email'],
    privacy_links: { 'ch-kr-privacy-policy': 'https://www.adobe.com/cn/privacy/china-privacy-policy.html' },
  },
  {
    purpose: [''],
    countries: ['CN'], // China
  ...
  },
  {
    ...
    optin_style: 'explicit',
    methods: ['email', 'phone'],
    privacy_links: { 'ch-kr-privacy-policy': 'https://www.adobe.com/privacy/korean-privacy-policy.html' },
  },
  {
    purpose: [''],
    countries: ['KR'], // Korea
  ...
  },
  {
    purpose: ['email'],
    countries: [],
    privacycode: 'cs4;ve1;<lc>',
    optin_style: 'implicit',
    methods: ['email', 'phone', 'subscription'],
    privacy_links: {},
  },
  {
    purpose: ['email'],
    countries: B2B_RFI_COUNTRIES,
    privacycode: 'cs4;ve1;<lc>',
    optin_style: 'implicit',
    methods: ['email', 'phone', 'subscription'],
    privacy_links: {},
