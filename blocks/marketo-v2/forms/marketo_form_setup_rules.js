...
if (typeof window.mcz_marketoForm_pref_example == "undefined") {
  ...
  if (
    currentUrl.includes("isTesting=")
  ) {
    window.mktoFrmLog = false;
    mkf_c.log(
  ...
  window.mcz_marketoForm_pref_example = {
    ...
    form: {
      ...
      mktoInstantInquiry: {
        //Trigger Inquiry from Person Activity Log (defaults to false)
